...
/**
 * Generated class for the AddHoroscopePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-add-horoscope',
  templateUrl: 'add-horoscope.html',
})

export class AddHoroscopePage {
...
serverToken:string;
  ...
  constructor(public navCtrl: NavController,
    ...
    public translate:TranslateService) {
      ...
      alertProvider.setCurrentPage(AddHoroscopePage);
      this.initiateLoder();
  ...
  ionViewDidLoad() {
   console.log('ionViewDidLoad AddHoroscopePage');
  }
  ...
  getImage() {
    ...
    this.camera.getPicture(options).then((imageData) => {
     ...
     // console.log(err);
      //alert(err);
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,err,null);
  ...
  saveProfile(status:string){
     ...
     console.log('upload data is', req); 
...
validate():boolean{
  ...
  let valid = true;
    if(this.horoscopeData.getHNativePhoto === this.imageURI){
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_add_horoscope_image,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_enter_name,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_gender,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_owner_dob_date,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_owner_dob_month,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_owner_dob_year,null);
     ...
     // alert(strings.please_select_owner_dob_hour);
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_owner_dob_hour,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_owner_dob_min,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_owner_dob_sec,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_owner_dob_am_pm,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_palce_of_birth,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.please_select_nearest_landmark_for_palce_of_birth,null);
...
uploadFile(req:HoroscopeResponseData) {
    ...
    console.log('upload data is ', options);
  ...
  addHoroscopeApi(image:string,fileTransfer:FileTransferObject,options:FileUploadOptions){
    ...
    .then((response) => {
     ...
     // alert('RES ' +JSON.stringify(JSON.parse(response.response)));
      //alert('DATA ' + data.getMessage);
        ...
        if(data && data.getStatus === 'Success'){
            ...
            if(data.getData){
              ...
              this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,data.getMessage,null);
      ...
      this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,JSON.stringify(err),null);
    });
  }
  ...
  let postData = new FormData();
     ...
     // alert("DATA1:"+req.getHMarriagePlace);
      ...
      this.api.updateHoroscope(postData).subscribe(response => {
        ...
        // this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,strings.server_error,null);

        if(error.toString().includes(Constants.RESPONSE_WITH_STATUS_0_1) 
          || error.toString().includes(Constants.RESPONSE_WITH_STATUS_0_2)){
          this.alertProvider.basicAlertOnPage(AddHoroscopePage,null, strings.please_check_internet_access, null);
        }else{
          this.alertProvider.basicAlertOnPage(AddHoroscopePage,null,error.toString(), null);
        }
      },() => {
        //this.loader.dismiss();
    ...
    ionViewWillEnter(){
      this.alertProvider.setCurrentPage(AddHoroscopePage);
    }
