...
import { AddHoroscopeDemisePage } from '../add-horoscope-demise/add-horoscope-demise';
/**
 * Generated class for the AddHoroscopeLastCallPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-add-horoscope-last-call',
  templateUrl: 'add-horoscope-last-call.html',
})
export class AddHoroscopeLastCallPage {
  ...
  constructor(public navCtrl: NavController,
    ...
    public translate: TranslateService) {
      ...
      this.alertProvider.setCurrentPage(AddHoroscopeLastCallPage);
  ...
  */
  ...
  ionViewDidLoad() {
    //console.log('ionViewDidLoad AddHoroscopeLastCallPage');
  }
  ...
  setAddHoroscopeDataIfExist() {
    if (this.horoscopeData) {
      if (this.horoscopeData.lastCallDay) {
        this.lastCallCalendar.setSelectedDate = this.horoscopeData.lastCallDay;
      }
      if (this.horoscopeData.lastCallMonth) {
        this.lastCallCalendar.setSelectedMonth = this.horoscopeData.lastCallMonth;
      }
      if (this.horoscopeData.lastCallYear) {
        this.lastCallCalendar.setSelectedYear = this.horoscopeData.lastCallYear;
      }

      if (this.horoscopeData.lastCallHour) {
        this.callTime.setSelectedHour = this.horoscopeData.lastCallHour;
      }

      if (this.horoscopeData.lastCallMin) {
        this.callTime.setSelectedMin = this.horoscopeData.lastCallMin;
      }

      if (this.horoscopeData.lastCallSec) {
        this.callTime.setSelectedSec = this.horoscopeData.lastCallSec;
      }

      if (this.horoscopeData.lastCallAmPm) {
        this.callTime.setSelectedAmPm = this.horoscopeData.lastCallAmPm;
      }
    }
  }
  ...
  setHoroscopeDataForUpdate() {
    ...
    if (this.horoscopeData 
      && this.horoscopeData.getHCrDate
      && this.horoscopeData.getHCrDate != Constants.BLANK_DATE_TIME) {
      if(this.horoscopeData.getHCrDate.includes("-") || this.horoscopeData.getHCrDate.includes("/")){
          ...
          this.horoscopeData.lastCallDay = this.lastCallCalendar.getSelectedDate;
          this.horoscopeData.lastCallMonth = this.lastCallCalendar.getSelectedMonth;
          this.horoscopeData.lastCallYear = this.lastCallCalendar.getSelectedYear;
      }
    }

    if (this.horoscopeData 
      && this.horoscopeData.getHCrTime
      && this.horoscopeData.getHCrTime != Constants.BLANK_DATE_TIME) {
      if(this.horoscopeData.getHCrTime.includes("-") || this.horoscopeData.getHCrTime.includes("/")){
          ...
          this.horoscopeData.lastCallHour = this.callTime.getSelectedHour;
          this.horoscopeData.lastCallMin=this.callTime.getSelectedMin;
          this.horoscopeData.lastCallSec = this.callTime.getSelectedSec 
          this.horoscopeData.lastCallAmPm = this.callTime.getSelectedAmPm;
        }
      }
  ...
  getImage() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      ...
      //console.log(err);
      //alert(err);
      this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, err, null);
  ...
  selectCallCalendar(type: number) {
    ...
    popover.onDidDismiss(popOverData => {
      ...
      if (type == Constants.CALENDAR_DATE) {
        //for local 
        this.horoscopeData.lastCallDay = popOverData.item;

        this.lastCallCalendar.setSelectedDate = popOverData.item;
      } else if (type == Constants.CALENDAR_MONTH) {
        //for local
        this.horoscopeData.lastCallMonth = this.lastCallCalendar.getMonthNumberFromName(popOverData.item);
        ...
        if (this.lastCallCalendar.selectedYear
          ...
          if (this.lastCallCalendar.getSelectedYear
            ...
            if (Number(this.lastCallCalendar.getSelectedDate) > 29) {
              //for local 
              this.horoscopeData.lastCallDay = null;
        ...
        //for local
        this.horoscopeData.lastCallYear = popOverData.item;
        ...
        if (this.lastCallCalendar.getSelectedMonth) {
          ...
          if (Number(this.lastCallCalendar.getSelectedYear) == this.lastCallCalendar.currentYear) {
            if (Number(this.lastCallCalendar.getSelectedMonth) > this.lastCallCalendar.currentMonth) {
              //for local
              this.horoscopeData.lastCallMonth = null;
  ...
  selectCallTime(timeType: number) {
    ...
    popover.onDidDismiss(popOverData => {
      ...
      if (timeType == Constants.TIME_HOUR) {
        //for local
        this.horoscopeData.lastCallHour = popOverData.item;

        this.callTime.setSelectedHour = popOverData.item;

      } else if (timeType == Constants.TIME_MIN) {
        //for local
        this.horoscopeData.lastCallMin = popOverData.item;
        ...
        //for local
        this.horoscopeData.lastCallSec = popOverData.item;

        this.callTime.setSelectedSec = popOverData.item;

      } else if (timeType == Constants.TIME_AM_PM) {
        //for local
        this.horoscopeData.lastCallAmPm = popOverData.item;
  ...
  saveProfile(status: string) {
    ...
    this.horoscopeData.setHCrDate = this.getEventDate(this.lastCallCalendar);
    this.horoscopeData.setHCrTime = this.getEventTime(this.callTime);
    this.horoscopeData.setHCrPlace = (this.horoscopeData.getHCrPlace && this.horoscopeData.getHCrPlace != null && this.horoscopeData.getHCrPlace != 'null') ? this.horoscopeData.getHCrPlace : "";
    this.horoscopeData.setHCrTAmpm = (this.callTime && this.callTime.getSelectedAmPm) ? this.callTime.getSelectedAmPm : null;

    this.navCtrl.push(AddHoroscopeDemisePage, {
      type: this.type,
  ...
  validate(): boolean {
    ...
    if(this.lastCallCalendar && (this.lastCallCalendar.getSelectedDate 
      || this.lastCallCalendar.getSelectedMonth 
      || this.lastCallCalendar.getSelectedYear)){
        if(!this.lastCallCalendar.getSelectedDate || this.lastCallCalendar.getSelectedDate === "00"){
          //alert(strings.please_select_call_date);
          this.isValidMarriageDate = false;
          this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.please_select_call_date, null);
          return false;
        }if(!this.lastCallCalendar.getSelectedMonth || this.lastCallCalendar.getSelectedMonth === "00"){
          //alert(strings.please_select_call_month);
          this.isValidMarriageMonth = false;
          this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.please_select_call_month, null);
          return false;
        }if(!this.lastCallCalendar.getSelectedYear || this.lastCallCalendar.getSelectedYear === "00"){
          //alert(strings.please_select_call_year);
          this.isValidMarriageYear = false;
          this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.please_select_call_year, null);
          return false;
        }
    }
    ...
    if(this.callTime && (this.callTime.getSelectedHour 
      ...
      || this.callTime.getSelectedAmPm)){
        if(!this.callTime.getSelectedHour || this.callTime.getSelectedHour === "00"){
          //alert(strings.please_select_call_date);
          this.isValidMarriageHours = false;
          this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.please_select_call_hour, null);
          return false;
        }
        if(!this.callTime.getSelectedMin){
          //alert(strings.please_select_call_month);
          this.isValidMarriageMin = false;
          this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.please_select_call_min, null);
          return false;
        }
        // if(!this.callTime.getSelectedSec){
        //   //alert(strings.please_select_call_year);
        //   this.isValidMarriageSec = false;
        //   this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.please_select_call_sec, null);
        //   return false;
        // }
        if(!this.callTime.getSelectedAmPm){
          //alert(strings.please_select_call_year);
          this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.please_select_call_am_pm, null);
          return false;
        }
      }
      ...
      .then((response) => {
        ...
        if (data && data.getStatus === 'Success') {
          ...
          if (data.getData) {
            ...
            this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, data.getMessage, null);
        ...
        this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, JSON.stringify(err), null);
      });
  }
  ...
  updateHoroscopeOnlyData(req: any) {
    ...
    this.api.updateHoroscope(postData).subscribe(response => {
      ...
      // this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.server_error, null);

      if(error.toString().includes(Constants.RESPONSE_WITH_STATUS_0_1) 
        || error.toString().includes(Constants.RESPONSE_WITH_STATUS_0_2)){
        this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null, strings.please_check_internet_access, null);
      }else{
        this.alertProvider.basicAlertOnPage(AddHoroscopeLastCallPage,null,error.toString(), null);
      }
    }, () => {
      //this.loader.dismiss();
