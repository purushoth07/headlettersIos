...
yahooLoginWithWeb(){
  ...
  yahooLoginWithWeb2(){
    ...
    //  let ref = window.open('https://api.login.yahoo.com/oauth2/request_auth?response_type=code&client_id=dj0yJmk9UlRGUzRhdlhvd0QzJmQ9WVdrOVJtSktRV051Tm1VbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD02MQ--&redirect_uri=https://headletters.com&scope=openid', '_blank', 'location=no');
    ...
    var ref = window.open("https://api.login.yahoo.com/oauth2/request_auth?response_type=code&client_id=dj0yJmk9UlRGUzRhdlhvd0QzJmQ9WVdrOVJtSktRV051Tm1VbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD02MQ--&redirect_uri=https://headletters.com/auth&scope=openid", '_blank', 'location=no');
    ref.addEventListener('loadstart', (event: any) => {
      console.log("LOGIN:","YAHOO2");
  if((event.url).indexOf('https://headletters.com') == 0) {
   let access_code = (event.url).split("code=")[1];
   let data = {
          redirect_uri: + this.YAHOO.redirectUrl,
