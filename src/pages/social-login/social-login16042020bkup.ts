   ...
   yahooLoginWithNative(){
    ...
    // alert("ALERT YAHOO 4");
     ...
     try{
      ...
      const browser = this.inAppBrowser.create('https://api.login.yahoo.com/oauth2/request_auth?client_id='+Constants.YAHOO_CLIENT_ID+'&redirect_uri=https://headletters.com&response_type=code', '_blank', 'location=no');
