...
export class SocialLoginPage implements OnInit{
   ...
   YAHOO = {
    clientId: 'dj0yJmk9ZHFJUHZENWFKZDlNJmQ9WVdrOVozTlROelphTjJjbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PWEx',
    clientSecret: 'de4ba3d7ec185f74912a3e3467ffa5d7173c738d',
    redirectUrl: 'https://w3schools.com',
...
yahooLoginWithWeb(){
  //window.open('https://api.login.yahoo.com/oauth2/request_auth?client_id='+Constants.YAHOO_CLIENT_ID+'&redirect_uri=https://w3schools.com/&response_type=token', '_blank', 'location=no')
  window.open('https://api.login.yahoo.com/oauth2/request_auth?client_id=dj0yJmk9Z21qZ3lUYU14YzAzJmQ9WVdrOWJucFNTVEZ1TXpnbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTAx&redirect_uri=https://stackoverflow.com&response_type=code', '_blank', 'location=no')
  //https://api.login.yahoo.com/oauth2/request_auth?client_id=dj0yJmk9Z21qZ3lUYU14YzAzJmQ9WVdrOWJucFNTVEZ1TXpnbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTAx&redirect_uri=https://stackoverflow.com&response_type=code 
  ...
  yahooLoginWithWeb2(){
    this.setJsonHeader();
    console.log(Constants.YAHOO_CLIENT_ID)
    //let ref = window.open('https://api.login.yahoo.com/oauth2/request_auth?client_id='+Constants.YAHOO_CLIENT_ID+'&redirect_uri=https://headletters.com&response_type=token', '_blank', 'location=no');
     //let ref = window.open('https://api.login.yahoo.com/oauth2/request_auth?client_id='+Constants.YAHOO_CLIENT_ID+'&redirect_uri=https://headletters.com&response_type=code', '_blank', 'location=no');
       //let ref = window.open('https://api.login.yahoo.com/oauth2/request_auth?client_id=dj0yJmk9Z21qZ3lUYU14YzAzJmQ9WVdrOWJucFNTVEZ1TXpnbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTAx&redirect_uri=https://stackoverflow.com/&response_type=code');
       //  *Meeban starts here* this is for testing which i created uri- stackoverflow*
       let ref = window.open('https://api.login.yahoo.com/oauth2/request_auth?client_id=dj0yJmk9Z21qZ3lUYU14YzAzJmQ9WVdrOWJucFNTVEZ1TXpnbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTAx&redirect_uri=https://www.google.com/&response_type=code');
       //let ref = window.open('https://api.login.yahoo.com/oauth2/request_auth?client_id=dj0yJmk9ZHFJUHZENWFKZDlNJmQ9WVdrOVozTlROelphTjJjbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PWEx&client_secret=6082e4c9043e07655a7bff6d1f496d46483ee759&redirect_uri=https://stackoverflow.com/&response_type=code');
      // https://api.login.yahoo.com/oauth2/request_auth?client_id=dj0yJmk9ZHFJUHZENWFKZDlNJmQ9WVdrOVozTlROelphTjJjbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PWEx&redirect_uri=https://headletters.com&response_type=token
       //dj0yJmk9ZHFJUHZENWFKZDlNJmQ9WVdrOVozTlROelphTjJjbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PWEx
      // *Meeban end here*
...
// });
    ...
    ref.addEventListener('loadstart', (event: any) => {
      ...
      if((event.url).indexOf('https://w3schools.com/') == 0) {
