...
export class SocialLoginPage implements OnInit{
   ...
   YAHOO = {
    ...
    // redirectUrl: 'https://headletters-d373f.firebaseapp.com/__/auth/handler',
    ...
    public appVersion : AppVersion,
      ...
      private translate:TranslateService) {
        this.appVersion.getVersionNumber().then((version => {
          ...
          console.log('app version number is', this.versionNumber);
        }));
  ...
  playdemo(){
    ...
    this.streamingMedia.playVideo('https://www.radiantmediaplayer.com/media/big-buck-bunny-360p.mp4', options);
  }
  ...
  googleLogin(){
    ...
    if(this.platform.is('cordova')){
      console.log("i am cordova calling first =============")
...
yahooLoginWithWeb(){
  ...
  yahooLoginWithWeb2(){
    this.setJsonHeader();
     ...
     //let ref = window.open('https://api.login.yahoo.com/oauth2/request_auth?response_type=code&client_id=dj0yJmk9UlRGUzRhdlhvd0QzJmQ9WVdrOVJtSktRV051Tm1VbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD02MQ--&redirect_uri=https://headletters.com','_blank', 'location=no');
...
// })
  ...
  async logoutFromGoogle(){
        ...
        // });
        // try{
        //   await this.googleplus.login(options);
        // }catch(e){
        //   alert(e);
        // }
  ...
  callLoginApi(medium:string){
    ...
    localLoader.present();
      ...
      console.log('sent value request', request);
      ...
      console.log("LOGIN_RESPONSE:"+JSON.stringify(data));
        ...
        console.log('status respose', loginResponse.getStatus, loginResponse);
        if(loginResponse && loginResponse.getStatus === 'Success'){
          console.log('1st method hit')
